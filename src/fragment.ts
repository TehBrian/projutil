...
export abstract class Fragment {
   ...
   * @see trace
   * @param _options the fragment options
   */
  prompt(_options: FragmentOptions): Promise<FragmentData> {
   ...
   */
  abstract trace(options: FragmentOptions, data: FragmentData): Promise<void>;
